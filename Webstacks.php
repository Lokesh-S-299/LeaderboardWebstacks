...
<nav class="navbar sticky-top navbar-light" style="background-color: #e3f2fd;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="http://localhost/The%20final/Log_in.php">Log In</a>
      </li>
      <li class="nav-item">
...
<pre style="font-size:40px; line-height:100%;font-family: segoe print;">

  <b>Come,Join the family of Learning,
  by competeting with international users.
  A place to get inspired and to become an inspiration.</b>
